...
export const modalProductTitel = document.querySelector('.modal-product__titel');
...
export const orderTotalAmount = document.querySelector('.order__total-ammout');
export const order = document.querySelector('.order');
export const orderWrapTitel = document.querySelector('.order__wrap-title');
